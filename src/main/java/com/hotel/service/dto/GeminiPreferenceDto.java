...
public class GeminiPreferenceDto {

    private String floorPref;       // HIGH, LOW, NONE
    private String elevatorPref;    // AWAY, NEAR, NONE
    private String cornerPref;      // PREFER, AVOID, NONE
    private boolean preferQuiet;    // true, false

    public GeminiPreferenceDto() {
    }
